...
In chiusura, citeremo rapidamente (e superficialmente) alcuni altri
possibili attacchi ad RSA. Di essi si devrebbe tener conto in ogni
...
\medskip
Vediamo di approfondire l'attacco delineato nel
punto~\eqref{item:fermat-vulnerable}.  Esso \`e basato sul seguente:
...
\TODO: Ottimizzazione del crivello. Avere un fattore
che differisce meno di ${\p{4n}}^{1/4}$ da $\sqrt n$ significa
fattorizzazione certa in un passo. Nel nostro caso, ci\`o significa che
$p$ e $q$ devono distare almeno $\XXX$.
