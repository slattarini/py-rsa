...
offrire una dimostrazione di ques'ultimo teorema rimarchevolmente semplice
ed indipendente dal \TFA.
%
...
\eqref{b|a e c|a}, otteniamo $c = uq$ e $b = vq$.  Dunque $q$ divide
...
entrambi $r = a - bcq$, quindi per induzione (essendo $r < bc \leq a$)
si ha $bc \divides r$, da cui $bc \divides \p{bcq + r} = a$.
%
\end{proof}

Inoltre, dato il teorema~\eqref{thm:TFA-c3}, \`e possibile derivarne
facilmente il teorema~\eqref{thm:TFA-c2}; da questo il
teorema~\eqref{thm:TFA-c1} segue come semplice corollario, e il
\TFA{} segue a sua volta quasi immediatamente da questo.

\begin{proof}[Dimostrazione del teorema~\eqref{thm:TFA-c2}]
Chiaramente $a \divides ab$, ed inoltre $m \divides ab$ per ipotesi.
Allora, essendo $a$ ed $m$ coprimi, per il teorema~\eqref{thm:TFA-c3}
