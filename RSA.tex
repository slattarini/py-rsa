...
usando~\eqref{b|a e c|a}, otteniamo $c = uq$ e $b = vq$.  Dunque $q$
...
\begin{proof}[Dimostrazione con sistema complete di residui]
\TODO
\end{proof}
...
\end{displaymath}
Per il lemma precdente, tutti i termini della sommatoria sono divisibili
